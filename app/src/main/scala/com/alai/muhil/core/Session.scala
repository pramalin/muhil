...
import com.alai.muhil.pages.Page
...
object Session {
    ...
    object Endpoints {
        ...
        val checkToken = new Endpoint[Msg] {
            ...
            val onError: HttpError => Msg = _ => InvalidateToken
        }
    }
    ...
    object Commands {
        ...
        def setAllSessionCookies(email: String, token: String, isFresh: Boolean): Cmd[IO, Msg] =
